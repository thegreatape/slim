...
import org.yuimozilla.javascript.debug.DebuggableScript;
import org.yuimozilla.javascript.debug.Debugger;
...
public class Context
{
     ...
     *         thread.
     * @see org.yuimozilla.javascript.Context#enter()
     * @see org.yuimozilla.javascript.Context#exit()
     */
    ...
    public static void addContextListener(ContextListener listener)
    {
        ...
        String DBG = "org.yuimozilla.javascript.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class cl = listener.getClass();
            Class factoryClass = Kit.classOrNull(
                "org.yuimozilla.javascript.ContextFactory");
     ...
     *
     * @see org.yuimozilla.javascript.ErrorReporter
     */
     ...
     * @see org.yuimozilla.javascript.SecurityController
     */
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see org.yuimozilla.javascript.Script
     */
    ...
    private static Class codegenClass = Kit.classOrNull(
                             "org.yuimozilla.javascript.optimizer.Codegen");
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class cl = Kit.classOrNull(
                          "org.yuimozilla.javascript.regexp.RegExpImpl");
            if (cl != null) {
