...
package org.yuimozilla.javascript.optimizer;
...
public class Codegen extends Interpreter
{
                          ...
                          boolean returnFunction)
    {
        ...
        String mainClassName = "org.yuimozilla.javascript.gen.c"+serial;
    ...
    private byte[] generateCode(String encodedSource)
    {
        ...
        if (hasScript) {
            cfw.addInterface("org.yuimozilla.javascript/Script");
...
*/
        ...
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "org.yuimozilla.javascript/BaseFunction",
                      "createObject",
                      "(Lorg.yuimozilla.javascript/Context;"
                      +"Lorg.yuimozilla.javascript/Scriptable;"
                      +")Lorg.yuimozilla.javascript/Scriptable;");
        ...
        cfw.add(ByteCode.INSTANCEOF, "org.yuimozilla.javascript/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "org.yuimozilla.javascript/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw)
    {
        ...
        cfw.addALoad(1); //cx
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "org.yuimozilla.javascript/ScriptRuntime",
                      "hasTopCall",
                      "(Lorg.yuimozilla.javascript/Context;"
                      +")Z");
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "org.yuimozilla.javascript/ScriptRuntime",
                      "doTopCall",
                      "(Lorg.yuimozilla.javascript/Callable;"
                      +"Lorg.yuimozilla.javascript/Context;"
                      +"Lorg.yuimozilla.javascript/Scriptable;"
                      +"Lorg.yuimozilla.javascript/Scriptable;"
                      +"[Ljava/lang/Object;"
    ...
    private void generateMain(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      mainMethodClass,
                      "main",
                      "(Lorg.yuimozilla.javascript/Script;[Ljava/lang/String;)V");
                                      ...
                                      OptFunctionNode ofn)
    {
        ...
        cfw.addALoad(SCOPE_ARG);
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "org.yuimozilla.javascript/NativeFunction",
                      "initScriptFunction",
                      "(Lorg.yuimozilla.javascript/Context;"
                      +"Lorg.yuimozilla.javascript/Scriptable;"
                      +")V");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                              "org.yuimozilla.javascript/RegExpProxy",
                              "compileRegExp",
                              "(Lorg.yuimozilla.javascript/Context;"
                         ...
                         int contextArg, int scopeArg)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "checkRegExpProxy",
                      "(Lorg.yuimozilla.javascript/Context;"
                      +")Lorg.yuimozilla.javascript/RegExpProxy;");
        // Stack: proxy, array
        cfw.add(ByteCode.DUP);
        cfw.addALoad(contextArg);
        ...
        if (num == 0.0) {
            if (1 / num > 0) {
                ...
                cfw.add(ByteCode.GETSTATIC,
                        "org.yuimozilla.javascript/optimizer/OptRuntime",
    ...
    {
        cfw.add(ByteCode.GETSTATIC, "org.yuimozilla.javascript/Undefined",
    ...
    String getBodyMethodSignature(ScriptOrFnNode n)
    {
        ...
        sb.append("Lorg.yuimozilla.javascript/Context;"
                  +"Lorg.yuimozilla.javascript/Scriptable;"
                  +"Lorg.yuimozilla.javascript/Scriptable;");
        if (n.getType() == Token.FUNCTION) {
            OptFunctionNode ofn = OptFunctionNode.get(n);
   ...
   static final String FUNCTION_CONSTRUCTOR_SIGNATURE
        = "(Lorg.yuimozilla.javascript/Scriptable;"
          +"Lorg.yuimozilla.javascript/Context;I)V";
...
class BodyCodegen
{
    ...
    private void generatePrologue()
    {
                ...
                || fnCurrent.fnode.getIgnoreDynamicScope()))
        {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                          "org.yuimozilla.javascript/Scriptable",
                          "getParentScope",
                          "()Lorg.yuimozilla.javascript/Scriptable;");
        ...
        if (fnCurrent != null) {
            ...
            addScriptRuntimeInvoke("createFunctionActivation",
                                   "(Lorg.yuimozilla.javascript/NativeFunction;"
                                   +"Lorg.yuimozilla.javascript/Scriptable;"
                                   +"[Ljava/lang/Object;"
                                   +")Lorg.yuimozilla.javascript/Scriptable;");
            cfw.addAStore(variableObjectLocal);
        ...
        if (compilerEnv.isGenerateDebugInfo()) {
            cfw.addVariableDescriptor(debugVariableName, "Lorg.yuimozilla.javascript/Scriptable;", cfw.getCurrentCodeOffset(), variableObjectLocal);
        }
    ...
    private void generateActivationExit()
    {
        ...
        addScriptRuntimeInvoke("exitActivationFunction",
                               "(Lorg.yuimozilla.javascript/Context;)V");
    }
        ...
        switch (type) {
              ...
              case Token.THROW:
                ...
                cfw.add(ByteCode.NEW,
                        "org.yuimozilla.javascript/JavaScriptException");
        ...
        switch (type) {
              ...
              case Token.REF_CALL:
                ...
                addScriptRuntimeInvoke(
                    ...
                    +"[Ljava/lang/Object;"
                    +"Lorg.yuimozilla.javascript/Context;"
                    +")Lorg.yuimozilla.javascript/Ref;");
                break;
                                  ...
                                  Node child)
    {
        ...
        if (type == Token.NEW) {
            ...
            callSignature = "(Lorg.yuimozilla.javascript/Context;"
                            +"Ljava/lang/Object;"
                            +"[Ljava/lang/Object;"
                            +"Lorg.yuimozilla.javascript/Scriptable;"
                            +"Lorg.yuimozilla.javascript/Scriptable;"
    ...
    private void visitStandardCall(Node node, Node child)
    {
        ...
        if (firstArgChild == null) {
            if (childType == Token.NAME) {
                ...
                generateFunctionAndThisObj(child, node);
                methodName = "call0";
                signature = "(Lorg.yuimozilla.javascript/Callable;"
                            +"Lorg.yuimozilla.javascript/Scriptable;"
                            +"Lorg.yuimozilla.javascript/Context;"
                            +"Lorg.yuimozilla.javascript/Scriptable;"
                            +")Ljava/lang/Object;";
...
*/
        ...
        if (type == Token.NEW) {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                "org.yuimozilla.javascript/Callable",
                "call",
                "(Lorg.yuimozilla.javascript/Context;"
                +"Lorg.yuimozilla.javascript/Scriptable;"
                +"Lorg.yuimozilla.javascript/Scriptable;"
                                    ...
                                    int exceptionLocal)
    {
        ...
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            exceptionName = "org.yuimozilla.javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            exceptionName = "org.yuimozilla.javascript/EvaluatorException";
        } else {
            if (exceptionType != ECMAERROR_EXCEPTION) Kit.codeBug();
            exceptionName = "org.yuimozilla.javascript/EcmaError";
        }
