...
public class ContextFactory
{
	...
	/**
		Provides a default {@link org.yuimozilla.javascript.xml.XMLLib.Factory XMLLib.Factory}
	 ...
	 */
	protected org.yuimozilla.javascript.xml.XMLLib.Factory getE4xImplementationFactory() {
		...
		if (Kit.classOrNull("org.apache.xmlbeans.XmlCursor") != null) {
			return org.yuimozilla.javascript.xml.XMLLib.Factory.create(
				"org.yuimozilla.javascript.xml.impl.xmlbeans.XMLLibImpl"
			);
		} else if (isDom3Present()) {
			return org.yuimozilla.javascript.xml.XMLLib.Factory.create(
				"org.yuimozilla.javascript.xmlimpl.XMLLibImpl"
			);
		} else {
