...
import org.yuimozilla.javascript.tools.shell.Global;
...
public class Main implements ContextListener {
     ...
     * {@link org.yuimozilla.javascript.tools.shell.Main} shell session.
     */
    public static void main(String[] args) {
        ...
        Global global = org.yuimozilla.javascript.tools.shell.Main.getGlobal();
        global.setIn(main.getIn());
        global.setOut(main.getOut());
        global.setErr(main.getErr());

        main.attachTo(
            org.yuimozilla.javascript.tools.shell.Main.shellContextFactory);
        ...
        org.yuimozilla.javascript.tools.shell.Main.exec(args);
    }
