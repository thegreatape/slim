...
package org.yuimozilla.javascript.drivers;
...
import org.yuimozilla.javascript.tools.shell.*;
...
public class JsDriver {
    ...
    void run(Arguments arguments) throws Throwable {
        if (arguments.help()) {
            ...
            System.out.println("Consult the Java source code at testsrc/org.yuimozilla.javascript/JsDriver.java for details.");
            System.exit(0);
        }
